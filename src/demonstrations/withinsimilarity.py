...
class WithinSimilarityDemonstration(SemanticDemonstration, DemographicDemonstration):
    ...
    def create_demonstrations(
        ...
        for demographic in test_pre_computed_inclusions:
            demographic_index = test_pre_computed_inclusions[demographic]
